...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-[#F0F0F0] dark:bg-[#1A1A1A] flex flex-col items-center justify-center p-6 text-center text-[#1A1A1A] dark:text-[#FDFCF0]">
            ...
            <Link
                to="/"
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#008080] to-teal-500 text-white font-bold rounded-full shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
            >
