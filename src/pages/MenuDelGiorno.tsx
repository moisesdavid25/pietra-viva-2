              ...
              <div className="space-y-6">
                {menu.entree && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.entree}</p>
                  </div>
                )}
                ...
                {menu.primo && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.primo}</p>
                  </div>
                )}
                ...
                {menu.secondo && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.secondo}</p>
                  </div>
                )}
                ...
                {menu.contorno && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.contorno}</p>
                  </div>
                )}
                ...
                {menu.desert && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.desert}</p>
                  </div>
                )}
                ...
                {menu.bevande && (
                  <div>
                    ...
                    <p className="font-serif text-lg italic text-[#1A1A1A] dark:text-gray-200">{menu.bevande}</p>
                  </div>
                )}
              </div>
