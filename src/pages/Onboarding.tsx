...
export default function Onboarding() {
    ...
    return (
        <div className="bg-[#FFFFFF] dark:bg-[#1A1A1A] font-sans min-h-screen flex items-center justify-center p-6 text-center">
            <div className="bg-white dark:bg-[#262626] p-8 rounded-3xl shadow-xl max-w-md w-full border border-gray-100 dark:border-gray-800">
                ...
                <button
                    ...
                    className="w-full bg-gradient-to-r from-[#008080] to-teal-500 hover:shadow-xl text-white font-bold py-3 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                >
